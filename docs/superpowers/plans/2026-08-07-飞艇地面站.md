...
- 所有代码注释用中文。
- 代码根目录：`ground_station/`（相对项目根 `lingyun_gcs/`）。
...
**Files:**
- Create: `ground_station/CMakeLists.txt`
- Create: `ground_station/src/main.cpp`
- Create: `ground_station/third_party/qcustomplot/`（放置下载的 qcustomplot.h/.cpp）
...
从 <https://www.qcustomplot.com/release/2.1.1/QCustomPlot-source.tar.gz> 下载，将 `qcustomplot.h` 与 `qcustomplot.cpp` 放入 `ground_station/third_party/qcustomplot/`。
...
**Files:**
- Create: `ground_station/src/model/telemetry_data.h`
- Create: `ground_station/src/model/telemetry_data.cpp`
...
`ground_station/src/model/telemetry_data.h`：
...
`ground_station/src/model/telemetry_data.cpp`：
...
```bash
git add ground_station/src/model/
...
**Files:**
- Create: `ground_station/src/comms/frame_parser.h`
- Create: `ground_station/src/comms/frame_parser.cpp`
- Test: `ground_station/tests/test_frame_parser.cpp`
...
`ground_station/src/comms/frame_parser.h`：
...
`ground_station/src/comms/frame_parser.cpp`：
...
`ground_station/tests/test_frame_parser.cpp`：
...
`ground_station/tests/tests.cmake`：
...
在 `ground_station/CMakeLists.txt` 末尾追加：
...
```bash
git add ground_station/src/comms/frame_parser.* ground_station/tests/
...
**Files:**
- Create: `ground_station/src/comms/json_decoder.h`
- Create: `ground_station/src/comms/json_decoder.cpp`
- Test: `ground_station/tests/test_json_decoder.cpp`
...
`ground_station/src/comms/json_decoder.h`：
...
`ground_station/src/comms/json_decoder.cpp`：
...
`ground_station/tests/test_json_decoder.cpp`：
...
在 `ground_station/tests/tests.cmake` 追加：
...
```bash
git add ground_station/src/comms/json_decoder.* ground_station/tests/
...
**Files:**
- Create: `ground_station/src/comms/serial_manager.h`
- Create: `ground_station/src/comms/serial_manager.cpp`
...
`ground_station/src/comms/serial_manager.h`：
...
`ground_station/src/comms/serial_manager.cpp`：
...
```bash
git add ground_station/src/comms/serial_manager.*
...
**Files:**
- Create: `ground_station/src/core/data_bus.h`
- Create: `ground_station/src/core/data_bus.cpp`
...
`ground_station/src/core/data_bus.h`：
...
`ground_station/src/core/data_bus.cpp`：
...
```bash
git add ground_station/src/core/data_bus.*
...
**Files:**
- Create: `ground_station/src/ui/status_bar.h`
- Create: `ground_station/src/ui/status_bar.cpp`
- Create: `ground_station/src/ui/device_panel.h`
- Create: `ground_station/src/ui/device_panel.cpp`
...
`ground_station/src/ui/status_bar.h`：
...
`ground_station/src/ui/status_bar.cpp`：
...
`ground_station/src/ui/device_panel.h`：
...
`ground_station/src/ui/device_panel.cpp`：
...
```bash
git add ground_station/src/ui/status_bar.* ground_station/src/ui/device_panel.*
...
**Files:**
- Create: `ground_station/src/core/alarm_engine.h`
- Create: `ground_station/src/core/alarm_engine.cpp`
...
`ground_station/src/core/alarm_engine.h`：
...
`ground_station/src/core/alarm_engine.cpp`：
...
```bash
git add ground_station/src/core/alarm_engine.*
...
**Files:**
- Create: `ground_station/src/core/recorder.h`
- Create: `ground_station/src/core/recorder.cpp`
...
`ground_station/src/core/recorder.h`：
...
`ground_station/src/core/recorder.cpp`：
...
```bash
git add ground_station/src/core/recorder.*
...
**Files:**
- Create: `ground_station/src/core/replay_engine.h`
- Create: `ground_station/src/core/replay_engine.cpp`
...
`ground_station/src/core/replay_engine.h`：
...
`ground_station/src/core/replay_engine.cpp`：
...
```bash
git add ground_station/src/core/replay_engine.*
...
**Files:**
- Create: `ground_station/src/core/config_manager.h`
- Create: `ground_station/src/core/config_manager.cpp`
...
`ground_station/src/core/config_manager.h`：
...
`ground_station/src/core/config_manager.cpp`：
...
```bash
git add ground_station/src/core/config_manager.*
...
**Files:**
- Create: `ground_station/src/ui/chart_widget.h`
- Create: `ground_station/src/ui/chart_widget.cpp`
...
`ground_station/src/ui/chart_widget.h`：
...
`ground_station/src/ui/chart_widget.cpp`：
...
```bash
git add ground_station/src/ui/chart_widget.*
...
**Files:**
- Create: `ground_station/src/ui/log_panel.h`
- Create: `ground_station/src/ui/log_panel.cpp`
- Create: `ground_station/src/ui/alarm_panel.h`
- Create: `ground_station/src/ui/alarm_panel.cpp`
- Create: `ground_station/src/ui/replay_panel.h`
- Create: `ground_station/src/ui/replay_panel.cpp`
- Create: `ground_station/src/ui/serial_config_dialog.h`
- Create: `ground_station/src/ui/serial_config_dialog.cpp`
...
`ground_station/src/ui/log_panel.h`：
...
`ground_station/src/ui/log_panel.cpp`：
...
`ground_station/src/ui/alarm_panel.h`：
...
`ground_station/src/ui/alarm_panel.cpp`：
...
`ground_station/src/ui/replay_panel.h`：
...
`ground_station/src/ui/replay_panel.cpp`：
...
`ground_station/src/ui/serial_config_dialog.h`：
...
`ground_station/src/ui/serial_config_dialog.cpp`：
...
```bash
git add ground_station/src/ui/log_panel.* ground_station/src/ui/alarm_panel.* \
       ground_station/src/ui/replay_panel.* ground_station/src/ui/serial_config_dialog.*
...
**Files:**
- Modify: `ground_station/src/main.cpp`
- Create: `ground_station/src/ui/main_window.h`
- Create: `ground_station/src/ui/main_window.cpp`
- Create: `ground_station/tools/serial_simulator.py`
...
`ground_station/src/ui/main_window.h`：
...
`ground_station/src/ui/main_window.cpp`：
...
`ground_station/src/main.cpp`（覆盖 Task 1 版本）：
...
`ground_station/tools/serial_simulator.py`：
